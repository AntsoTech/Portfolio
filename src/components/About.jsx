  ...
  return (
    <div className="about">
      ...
      <div className="about__paragraph">
        <quote className="about__paragraph__quote">
      ...
      <div className="about__info">
        <div className="about__info__intro">
          ...
          <p>
            ...
            node.js. Je suis actuellement en recherche d’un stage pour continuer
            à progresser et aider une entreprise à générer de la valeur pour
            leurs clients.
          </p>
        </div>
